...
`use strict` - активация новых возможностей языка. По умолчанию отключен, чтобы работал легаси код.
...
### same-origin policy, принцип одинакового истоника
...
Прикладной протокол, который служит основой для обмена данными между клиентами и серверами.
